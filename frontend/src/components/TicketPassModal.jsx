...
import { Ticket, Calendar, Clock, MapPin, CheckCircle, X, Copy, Check, Printer, User, ShieldCheck, Sparkles, Building, AlertTriangle } from 'lucide-react';
      ...
      >
        ...
        >
          ...
          <div className="official-ticket-card" id="printable-ticket">
            ...
            {/* Expired Event Warning Banner */}
            {expired && (
              <div className="ticket-expired-banner">
                <div className="ticket-expired-icon-wrap">
                  <AlertTriangle size={18} />
                </div>
                <div className="ticket-expired-content">
                  <div className="ticket-expired-title">This Event Has Ended</div>
                  <div className="ticket-expired-message">
                    This ticket is no longer valid for entry because the event has already concluded.
                  </div>
                </div>
              </div>
            )}
